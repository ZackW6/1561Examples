...
import frc.robot.commands.BranchingAutos;
import frc.robot.commands.FactoryCommands;
import frc.robot.commands.BranchingAutos.BranchInstruction;
import frc.robot.commands.BranchingAutos.BranchInstruction.BeginPose;
import frc.robot.commands.BranchingAutos.BranchInstruction.PiecePose;
import frc.robot.commands.BranchingAutos.BranchInstruction.ShootPose;
...
public class RobotContainer {
  ...
  public RobotContainer() {
    ...
    autoChooser.addOption("Choreo Branching",
      BranchingAutos.createBranchCommand(()->(int)(Math.random()+.5) == 1,
        BranchInstruction.of(BeginPose.BeginUpper, ShootPose.ShootMiddle),
        BranchInstruction.of(PiecePose.FirstPiece, ShootPose.ShootMiddle),
        BranchInstruction.of(PiecePose.SecondPiece, ShootPose.ShootMiddle)));
  }
