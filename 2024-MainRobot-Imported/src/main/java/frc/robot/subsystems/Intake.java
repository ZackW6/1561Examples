...
public class Intake extends SubsystemBase{
    ...
    private final FlywheelSim fSim = new FlywheelSim(LinearSystemId.createFlywheelSystem(DCMotor.getFalcon500((1)),IntakeConstants.MOMENT_OF_INERTIA, IntakeConstants.GEARING),
