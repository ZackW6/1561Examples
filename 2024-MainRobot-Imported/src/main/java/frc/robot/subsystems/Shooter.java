...
public class Shooter extends SubsystemBase{
    ...
    private final FlywheelSim fSimL = new FlywheelSim(LinearSystemId.createFlywheelSystem(DCMotor.getFalcon500((1)),
    .001, 1),
     DCMotor.getFalcon500(1), 0);

    private FlyWheelSim flywheelSimL;

    private final FlywheelSim fSimR = new FlywheelSim(LinearSystemId.createFlywheelSystem(DCMotor.getFalcon500((1)),
    .001, 1),
     DCMotor.getFalcon500(1), 0);
