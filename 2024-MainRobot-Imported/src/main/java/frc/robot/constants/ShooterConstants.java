...
public class ShooterConstants {
    ...
    public static final double kS; // Add 0.25 V output to overcome static friction
    public static final double kV; // A velocity target of 1 rps results in 0.12 V output
    public static final double kA; // An acceleration of 1 rps/s requires 0.01 V output
    public static final double kP = 20;//8; // This will need to be tuned after feedforward
    public static final double kI; // For flywheels, this should be 0
