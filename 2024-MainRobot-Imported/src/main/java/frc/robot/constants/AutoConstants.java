...
public class AutoConstants {
    // public static final PPHolonomicDriveController HOLONOMIC_CONFIGS = new PPHolonomicDriveController( // HolonomicPathFollowerConfig, this should likely live in your Constants class
    //             new PIDConstants(5, 0.0, 0.0), // Translation PID constants
    //             new PIDConstants(5, 0.0, 0.0), // Rotation PID constants
    //             4.5, // Max module speed, in m/s
    //             0.323, // Drive base radius in meters. Distance from robot center to furthest module.
    //             new RobotConfig.fromGUISettings() // Default path replanning config. See the API for the options here
    //     );
