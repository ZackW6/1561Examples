...
public class SimMotor extends VirtualSubsystem implements BaseMotor{
    ...
    PIDController positionController = new PIDController(10, 0, 0.0);
    ...
    public void set(double x) {
        motorSim.setInputVoltage((x * (maxVoltage-(getVelocity()/5)*frictionCoef) * (isInverted ? -1 : 1)));
    }
