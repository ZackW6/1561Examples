...
import frc.robot.motors.baseControl.SteerMotor;

public class TalonSteer implements SteerMotor{
    private TalonFX motor;
    private CANcoder canCoder;

    private PositionTorqueCurrentFOC positionController = new PositionTorqueCurrentFOC(0);

    public TalonSteer(int motorID, int encoderID){
    ...
    public void setPosition(double position) {
        motor.setControl(positionController.withPosition(position));
    }
