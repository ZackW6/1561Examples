...
public class ArmConstants{
    ...
    public static final double MAX_ARM_ANGLE_RAD = Units.rotationsToRadians(1);
    public static final double MIN_ARM_ANGLE_RAD = Units.rotationsToRadians(0);
    ...
    public static final double ARM_ROTOR_TO_SENSOR_RATIO = 30;
