package frc.robot.util.mapleSimWorlds;
...
public class MapleSim2025{

    private static final MapleSim2025 instance;
    static{
        if (Robot.isSimulation()){
            instance = new MapleSim2025();
        }else{
            instance = null;
        }
    }
    ...
    public static Optional<MapleSim2025> getInstance(){
    ...
    public static void addMainDrive(AbstractDriveTrainSimulation mainDrive){
        ...
        new Trigger(()->drive.getSimulatedDriveTrainPose().minus(GameData.feederPose(1)).getTranslation().getNorm() < 2)
