...
public class DriveBaseConstants {
    public static final double speedAt12Volts = 4.14;
    public static final double maxRotationRad = 2.2 * Math.PI;
    ...
    public class SimMotorConstants{
        public static final double driveFrictionCoef = 0.0;
        public static final double driveJKG = .08;

        public static final double steerFrictionCoef = 0.00;
     ...
     */
    public static final SwerveBase drive;
    static{
        if (Robot.isSimulation()){
            drive = new SimSwerve(0, List.of(
                ...
                , new SimMotor(frontLeftSteerID, TalonMotorConstants.steerGearRatio, SimMotorConstants.steerJKG, SimMotorConstants.steerFrictionCoef, DCMotor.getKrakenX60(1)).setInvert(true)
                , new Translation2d(driveBaseRadiusMeters,driveBaseRadiusMeters),wheelRadiusInches).withDrivePID(1, 0, 0).withSteerPID(5,0,0),
                ...
                , new SimMotor(frontRightSteerID, TalonMotorConstants.steerGearRatio, SimMotorConstants.steerJKG, SimMotorConstants.steerFrictionCoef, DCMotor.getKrakenX60(1)).setInvert(true)
                , new Translation2d(driveBaseRadiusMeters,-driveBaseRadiusMeters),wheelRadiusInches).withDrivePID(1, 0, 0).withSteerPID(5,0,0),
                ...
                , new SimMotor(backLeftSteerID, TalonMotorConstants.steerGearRatio, SimMotorConstants.steerJKG, SimMotorConstants.steerFrictionCoef, DCMotor.getKrakenX60(1)).setInvert(true)
                , new Translation2d(-driveBaseRadiusMeters,driveBaseRadiusMeters),wheelRadiusInches).withDrivePID(1, 0, 0).withSteerPID(5,0,0),
                ...
                , new SimMotor(backRightSteerID, TalonMotorConstants.steerGearRatio, SimMotorConstants.steerJKG, SimMotorConstants.steerFrictionCoef, DCMotor.getKrakenX60(1)).setInvert(true)
                , new Translation2d(-driveBaseRadiusMeters,-driveBaseRadiusMeters),wheelRadiusInches).withDrivePID(1, 0, 0).withSteerPID(5,0,0)
            ));
        }else{
            drive = new SwerveDrive(0, List.of(
