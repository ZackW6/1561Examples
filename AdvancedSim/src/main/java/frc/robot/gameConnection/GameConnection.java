...
public class GameConnection {
    ...
    private static SwerveDriveOdometry driveOdometry;
    private static Consumer<Rotation2d> gyroC;
    private static Supplier<SwerveModuleState[]> moduleStates;
    ...
    public static void initConnection(SwerveDriveKinematics kinematics,
        ...
        gyroC = gyroConsumer;
        moduleStates = moduleStateSupplier;
    ...
    public static void drivePeriodic(){
        try {
            if (driveKinematics == null || moduleStates == null || !isConnected()){
                return;
            }
            ChassisSpeeds speeds = driveKinematics.toChassisSpeeds(moduleStates.get());
